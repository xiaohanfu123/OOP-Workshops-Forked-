...
namespace seneca {
    void printGraph(int samples[], int noOfSamples, const char* label) {
        ...
        for (int i = noOfSamples - 1; i >= 0; i--) {
            ...
            int labelValue = (i + 1) * 10;// This will be 100 
            // then 90, 80, and so on.
            printInt(labelValue, 3); // Print the label for the bar with a width of 3
            cout << " ";
            printBar(samples[i], max); //  samples are ordered from highest range to lowest
